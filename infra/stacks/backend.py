...
class BackendStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # EC2 인스턴스
        app_asset = s3_assets.Asset(self, "FastAPIAsset", path="./app")
        ...
        environment_variables = {
            ...
            "DATABASE_PORT": "5432",
            "DATABASE_NAME": database_name,
            "DATABASE_USER": credentials.username_as_string,
            "DATABASE_PASSWORD": credentials.password if credentials.password is not None else "",
        }
        ...
        commands.add_commands(
            ...
            "nohup python3 -m /root/.cargo/bin/uv run uvicorn main:app --host 0.0.0.0 --port 80 --app-dir ~/app > ~/app/server.log 2>&1 &"
        )
